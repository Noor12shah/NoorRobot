...
UPSTREAM_REPO_URL = "https://github.com/Noor12shah/NoorRobot.git"
...
async def upstream(ups):
    ...
    if HEROKU_API_KEY is not None:
        ...
        if not HEROKU_APP_NAME:
            await ups.edit('CAT Please set up the `HEROKU_APP_NAME` variable to be able to update bot.')
            repo.__del__()
            return
        ...
        await ups.edit("Updating and Deploying New Update. Please wait for 5 minutes then use `.alive` to check if i'm working or not, you are my best boss...🤗🤗😎.. Just after this update a restart will take place..that's all- your  Noorbot by @innocent_noor ")
